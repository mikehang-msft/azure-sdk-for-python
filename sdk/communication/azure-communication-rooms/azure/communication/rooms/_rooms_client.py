...
class RoomsClient(object):
    ...
    def update_room(
        ...
        **kwargs: Any
        ...
        :keyword datetime valid_from: Optional. The timestamp from when the room is open for joining.
        :keyword datetime valid_until: Optional. The timestamp from when the room can no longer be joined.
