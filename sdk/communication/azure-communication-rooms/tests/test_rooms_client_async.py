...
class TestRoomsClientAsync(ACSRoomsTestCase):
    ...
    async def test_create_room_pstnDialOutEnabled(self):
        ...
        async with self.rooms_client:
            response = await self.rooms_client.create_room(pstnDialOutEnabled=False)
    ...
    async def test_create_room_timerange_pstnDialOutEnabled(self):
        ...
        async with self.rooms_client:
            response = await self.rooms_client.create_room(valid_from=valid_from, valid_until=valid_until, pstnDialOutEnabled=False)
